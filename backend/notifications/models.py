...
class Notification(models.Model):
    category = models.ForeignKey(Category, related_name='notification_category', on_delete=models.CASCADE)

    title = models.CharField(max_length=255)

    message = HTMLField(verbose_name="Message")

    gallery = models.ForeignKey(Gallery, related_name='notification_image', null=True, blank=True, on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse("notification_detail", kwargs={"slug": self.slug})
